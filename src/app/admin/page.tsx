        ...
        <div style={{ marginBottom: 48 }}>
          ...
          <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 'var(--radius)' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              ...
              <tbody>
                {flagged.map((g: { id: string; flagReason: string | null; createdAt: Date; user: { email: string } }) => (
      ...
      <div>
        ...
        <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 'var(--radius)' }}>
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            ...
            <tbody>
              {recentUsers.map((u: { id: string; email: string; plan: string; usageCount: number; createdAt: Date }) => (
