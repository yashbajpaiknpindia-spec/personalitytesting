...
export async function GET() {
  try {
    ...
    const [
      ...
      db.userWebsite.count({ where: { userId } }).catch(() => 0),
    ...
    return NextResponse.json({
      stats: {
        ...
        cardViews,
        totalLeads,
        totalGenerations: totalGenerations + totalWebsites,
        totalExports,
      },
      portfolio: portfolio
        ? {
            ...
            url: `${process.env.NEXT_PUBLIC_APP_URL || 'https://www.brandsyndicate.in'}/p/${portfolio.slug}`,
          }
        : null,
