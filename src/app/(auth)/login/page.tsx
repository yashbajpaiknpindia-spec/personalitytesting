...
function LoginForm() {
  ...
  async function handleSignIn(e: React.FormEvent) {
    ...
    if (res?.error) {
      ...
      // BUG FIX #6: Use hard navigation so middleware re-reads fresh session cookie.
      // router.push() is client-side only and the server middleware won't see the new token.
