        ...
        <div style={{ display: previewPanel==='preview' ? 'none' : 'block', minWidth:0 }} className="portfolio-edit-left">
          ...
          <div style={{ background:'var(--surface)', border:'1px solid var(--border)', borderRadius:'var(--radius)', padding:24, marginBottom:20 }}>
            ...
            <div style={{ fontSize:11, color:'var(--muted2)', marginTop:4 }}>
              Edit via <Link href="/resume/edit" style={{ color:accent, textDecoration:'none' }}>Resume Editor</Link> or <Link href="/card/edit" style={{ color:accent, textDecoration:'none' }}>Card Editor</Link>.
            </div>
            {/* Hero image */}
          ...
          {(output.skills??[]).length>0 && (
            <div style={{ background:'var(--surface)', border:'1px solid var(--border)', borderRadius:'var(--radius)', padding:24, marginBottom:20 }}>
              ...
              <div style={{ fontSize:11, color:'var(--muted2)', marginTop:8 }}>Edit skills via the <Link href="/resume/edit" style={{ color:accent, textDecoration:'none' }}>Resume Editor</Link>.</div>
            </div>
          )}
