...
const PortfolioManagerClient = dynamic(() => import('./PortfolioManagerClient'), { loading: () => <div style={{padding:40,textAlign:'center',color:'var(--muted)',fontFamily:'DM Mono,monospace',fontSize:11,letterSpacing:'0.1em'}}>Loading portfolio…</div> })
