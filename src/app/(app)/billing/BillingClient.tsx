...
const FALLBACK_PLANS = [
  { planId: 'FREE', name: 'Free', price: '₹0', period: '/month', features: '["3 generations per month","12 free templates","PDF export (watermarked)","Public portfolio URL","QR code generation"]', isVisible: true, highlight: false },
  { planId: 'PRO',  name: 'Pro',  price: '₹1,499', period: '/month', features: '["Unlimited generations","All 48 templates","PDF, PPTX, vCard export","No watermarks","Version history","Priority processing","Analytics dashboard"]', isVisible: true, highlight: true },
  { planId: 'TEAM', name: 'Team', price: '₹3,999', period: '/month', features: '["Everything in Pro","Up to 5 team members","Shared template library","Brand kit management","Admin dashboard","Priority support"]', isVisible: true, highlight: false },
]
