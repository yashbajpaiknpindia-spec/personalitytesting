...
export default function ReferralsClient({ referralCode, referredCount, appUrl }: Props) {
  ...
  return (
    <div className="page-pad" style={{ maxWidth: 680 }}>
      <div className="page-eyebrow"><span className="page-eyebrow-dot" />Referrals</div>
      <h1 className="page-h1">Refer &amp; <em>earn.</em></h1>
      <p className="page-sub">Share Brand Syndicate with your network. Earn credits for every signup with your link.</p>
